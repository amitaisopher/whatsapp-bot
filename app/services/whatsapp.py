...
from app.core.logging import application_logger as logger
...
class WhatsAppService:
    ...
    async def send_message(self, to: str, content: str) -> None:
        message = Message(instance=self.whatsapp_client, content=content, to=to) # this is your message instance, sender is the phone number key you want to use
        message.send(sender='my_whatsapp_phone_number_id')
